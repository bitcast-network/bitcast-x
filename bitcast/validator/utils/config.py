...
SCORING_INTERVAL_MINUTES = 120  # 120 steps × 10s = 20 minutes
THOROUGH_SCORING_INTERVAL_MINUTES = 2880  # 2880 steps × 10s = 8 hours
...
bt.logging.info(f"SCORING_INTERVAL: {SCORING_INTERVAL_MINUTES} steps ({SCORING_INTERVAL_MINUTES * VALIDATOR_WAIT // 60} min)")
bt.logging.info(f"THOROUGH_SCORING_INTERVAL: {THOROUGH_SCORING_INTERVAL_MINUTES} steps ({THOROUGH_SCORING_INTERVAL_MINUTES * VALIDATOR_WAIT // 3600} hr)")
