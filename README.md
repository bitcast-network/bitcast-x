...
This checkout prepares software version `3.0.0`; see the
[legacy retirement upgrade guide](docs/upgrade-3.0.md) before updating an existing deployment.
Software release numbers are separate from the protocol
