...
class TestTwitterEvaluator:
    ...
    async def test_evaluate_briefs_error_in_brief_continues(self, mock_alpha_price):
        ...
        def mock_score(pool_name, brief_id, connected_accounts, tag, qrt, run_id, start_date, end_date, max_members=None, considered_accounts=None, thorough=False, **kwargs):
